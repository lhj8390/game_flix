...
<meta charset="UTF-8">
 ...
 <meta http-equiv="contebt-type" content="text/html;">
    ...
    <title>[공지사항 & 게시판]</title> <!-- css path MODIFYME -->
...
<div class=container>
   <div class="board_list_wrap">
    <table class="board_list">
        <caption class="table_caption">게시판</caption>
        <thead>
            <tr class="border_tr">
                <th>번호</th>
                <th >제목</th>
    ...
    <div class="paging">
        ...
        <a href="board_insert.jsp" class="btn_write">글쓰기</a>
    </div>
</div>
</div>
  <script>$('body').hide().fadeIn('slow');</script>
