...
<link rel="stylesheet" href="${contextPath}/admin/css/header.css">
</head>
<body>
<div id="headerbody">
<nav id="topMenu">
                <ul>
                    ...
                    <li><a class="menuLink" 
                    href="${contextPath}/admin/gameContent/totalMembers.jsp">유저 관리</a></li>
                    <li><a class="menuLink" 
                    href="${contextPath}/admin/board/boardContent.jsp">게시판 관리</a></li>
                </ul>
            </nav>
            <nav id="userMenu">
                <ul>
